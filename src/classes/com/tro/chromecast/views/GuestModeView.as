...
package com.tro.chromecast.views
{
	...
	public class GuestModeView extends View
	{
		...
		override public function prepareViewOut(direction:String):void
		{
			super.prepareViewOut(direction);
			TweenMax.to(popUp, 0.25, { autoAlpha: 0});
		}
